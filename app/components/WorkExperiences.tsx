...
export function WorkExperiences() {
  return (
    <div id="experience" className="mb-4">
      <h2 className="mt-8 mb-2 flex gap-2 text-lg uppercase">
        <BriefcaseBusiness /> Expériences
      </h2>
      <div className="flex flex-col gap-4">
        ...
        >
          ...
          <ul>
            ...
            <li>Mise en place infra GCP-Kubernetes / Migration AWS vers GCP</li>
        ...
        >
          ...
          <ul>
            <li>
              des données relatives au <strong>compte client</strong> ainsi que
              de leur mise à disposition au travers d'API/Services
            </li>
        ...
        >
          ...
          <p>
            ...
            permettant de configurer ces modules pour les clients de Traveldoo.
          </p>
          <p>Objectifs :</p>
          <ul>
        ...
        >
          ...
          <p>
            Mission : Le SI de la SNCF souhaite construire un référentiel client
            enrichi et personnalisé pour apporter plus d'efficacité commerciale.
          </p>
          <p>Objectifs :</p>
          <ul>
          ...
          <h4 id="applicationconnectrenommeaujourdhuimonidentifiantsncf">
            Application "Connect" (renommée aujourd'hui "Mon Identifiant SNCF")
          </h4>
          <p>
        ...
        >
          ...
          <ul>
            <li>
              développements sur une application utilisée par les agents à bord
              des trains.
            </li>
            <li>
              participation à la conception et aux développements d'une nouvelle
              application permettant aux agents de la SNCF de diffuser des
        ...
        >
          ...
          <ul>
            <li>
              ...
              données locales vers une base de données centralisée à travers la
              mise en place d'une couche de WebServices REST.
            </li>
            <li>
        ...
        >
          ...
          <ul>
            <li>
              conception et mise en oeuvre d'un portail web pour la déclaration
        ...
        >
          ...
          <ul>
            <li>
              développement et tests pour un lot d'évolution sur Orassamis, une
              application de gestion des subventions aux clubs de sport.
            </li>
          </ul>
          <p>Rôle : </p>
          <ul>
